            ...
            {checkList.map((product, i) => (
                <div className={i === 0 ? "product first" : "product"} key={product["uuid"]}>
                    <div className="content">
                        <div className={cartProducts[i] ? "check selected" : "check"} onClick={() => addToCart(i)}></div>
            ...
            <Popup show={showAddPopup} setShow={setShowAddPopup}>
                ...
                <form autoComplete="off" noValidate spellCheck="false" onSubmit={onAddForm}>
                    <div className="inputContainer">
                        <input className="input" type="text" placeholder="name" name="name" value={addForm.name} onChange={onAddFormChange} autoComplete="new-password"></input>
                    </div>
    ...
    return (
        <Tab>
            <div className="checkList">
                <p className="mainTitle">Shopping List</p>
                {products}
